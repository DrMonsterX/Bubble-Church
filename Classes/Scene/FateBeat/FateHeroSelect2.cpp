...
//init scene
Scene* FateHeroSelect2::createScene(char* hero1)
{
	auto scene = Scene::create();
	auto layer = FateHeroSelect2::create(hero1);
...
//overload create() to accept information of hero1
FateHeroSelect2* FateHeroSelect2::create(char* aimhero1)
{
	FateHeroSelect2* pRet = new FateHeroSelect2();
...
bool FateHeroSelect2::init()
{
	...
	MenuItemImage* heroItem1 = MenuItemImage::create(
		"zystand41.png",
		"HeroSelect.png",
		CC_CALLBACK_1(FateHeroSelect2::menuHeroCallback1, this));
	...
	MenuItemImage* heroItem2 = MenuItemImage::create(
		"ssxstand41.png",
		"HeroSelect.png",
		CC_CALLBACK_1(FateHeroSelect2::menuHeroCallback2, this));
	...
	MenuItemImage* heroItem3 = MenuItemImage::create(
		"hyystand41.png",
		"HeroSelect.png",
		CC_CALLBACK_1(FateHeroSelect2::menuHeroCallback3, this));
	...
	MenuItemImage* heroItem4 = MenuItemImage::create(
		"ddstand41.png",
		"HeroSelect.png",
		CC_CALLBACK_1(FateHeroSelect2::menuHeroCallback4, this));
	...
	MenuItemImage* SelectItem = MenuItemImage::create(
		"SelectNormal.png",
		"SelectSelect.png",
		CC_CALLBACK_1(FateHeroSelect2::menuSelectCallBack, this));
...
void FateHeroSelect2::menuHeroCallback1(cocos2d::Ref* pSender)
{
	hero2 = "zy";
}
...
void FateHeroSelect2::menuHeroCallback2(cocos2d::Ref* pSender)
{
	hero2 = "ssx";
}
...
void FateHeroSelect2::menuHeroCallback3(cocos2d::Ref* pSender)
{
	hero2 = "hyy";
}
...
void FateHeroSelect2::menuHeroCallback4(cocos2d::Ref* pSender)
{
	hero2 = "dd";
}
...
void FateHeroSelect2::menuSelectCallBack(cocos2d::Ref* pSender)
{
	auto scene = FateMapSelect::createScene(hero1, hero2);
