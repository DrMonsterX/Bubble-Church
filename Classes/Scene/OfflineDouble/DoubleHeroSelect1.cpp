...
Scene* DoubleHeroSelect1::createScene()
{
	...
	auto layer = DoubleHeroSelect1::create();
...
bool DoubleHeroSelect1::init()
{
	...
	MenuItemImage* heroItem1 = MenuItemImage::create(
		"zystand41.png",
		"HeroSelect.png",
		CC_CALLBACK_1(DoubleHeroSelect1::menuHeroCallback1, this));
	...
	MenuItemImage* heroItem2 = MenuItemImage::create(
		"ssxstand41.png",
		"HeroSelect.png",
		CC_CALLBACK_1(DoubleHeroSelect1::menuHeroCallback2, this));
	//set button's attribute
	...
	MenuItemImage* heroItem3 = MenuItemImage::create(
		"hyystand41.png",
		"HeroSelect.png",
		CC_CALLBACK_1(DoubleHeroSelect1::menuHeroCallback3, this));
	//set button's attribute	
	...
	MenuItemImage* heroItem4 = MenuItemImage::create(
		"ddstand41.png",
		"HeroSelect.png",
		CC_CALLBACK_1(DoubleHeroSelect1::menuHeroCallback4, this));
    //set button's attribute	
	...
	MenuItemImage* SelectItem = MenuItemImage::create(
		"SelectNormal.png",
		"SelectSelect.png",
		CC_CALLBACK_1(DoubleHeroSelect1::menuSelectCallBack, this));
	//set button's attribute	
